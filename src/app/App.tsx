...
const projects = [
  {
    id: 6, name: "USS App", category: "UX Research · Educación", year: "2022–2023",
    description: "Rediseño de la app institucional de la Universidad San Sebastián. Lideré la investigación de usuarios que identificó los insights clave para mejorar la experiencia y navegación.",
  ...
  {
    id: 3, name: "Teamway", category: "UX Lead · Ecommerce · Retail", year: "2023–2024",
    description: "Feature OCR para la app Jumbo de Cencosud. Lideré el proceso completo desde research con 4 perfiles de usuario hasta prototipado hi-fi con 87% de efectividad.",
    ...
    process: [
      ...
      "Customer Journey Map con la iniciativa OCR integrada",
      "7 User Stories: fotografiar receta, subir desde galería, agregar al carro",
      "Análisis heurístico: 104/120 puntos = 87% de efectividad",
      "AI Heatmap predictivo para detectar oportunidades de mejora",
    ],
