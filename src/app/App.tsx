...
const projects = [
  ...
  },
  {
    ...
    process: [
      ...
      "Framework Wizard Sprint: Ingresar → Entender → Idear → Validar → Prototipar → Testear → Delivery",
      "Iniciativa OCR: fotografiar recetas/listas para agregar ingredientes automáticamente al carro",
      "Iniciativa Asistente IA: chatbot con inteligencia artificial para recetas y listas de compras",
      "Iniciativa Seguimiento: snackbar de estado en home y mapa en tiempo real del despacho",
      "Cada iniciativa entregada como prototipo hi-fi en 2 semanas, con handoff a equipo de desarrollo si era aprobada",
    ],
    impact: "★ Múltiples iniciativas prototipadas y aprobadas para implementación en producción",
  },
  {
