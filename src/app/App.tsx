...
const projects = [
  ...
  },
  {
    ...
    gallery: [
      { src: "/portafolio-smelendez/tw-asistente-ai.png", label: "Flujo completo del asistente IA con recetas" },
    ],
    process: [
      "Definición del flujo conversacional: saludo → intención → receta → productos → carro",
      "Diseño de onboarding con aceptación de política de privacidad",
      "Integración visual con la plataforma de ecommerce para ver productos desde el chat",
      "Estados del chat: escritura, respuesta con lista de ingredientes y CTA 'Ver productos'",
      "Prototipo hi-fi entregado en 2 semanas bajo framework Wizard Sprint",
    ],
  ...
  },
  {
    ...
    imageUrl: "/portafolio-smelendez/tw-flow-chart.png",
    gallery: [
      { src: "/portafolio-smelendez/tw-flow-chart.png", label: "Flow chart: fotografía → ingredientes → pre-carro" },
    ],
    process: [
      "Research con 4 perfiles de usuario: Exploradora, Eficiente, Selectiva y Oportunista",
      ...
      "Flujo: icono en buscador → cámara/galería → reconocimiento → pre-carro → carro final",
      "Análisis heurístico: 104/120 puntos = 87% de efectividad · AI Heatmap predictivo",
    ],
  ...
  },
  {
    ...
    imageUrl: "/portafolio-smelendez/tw-seguimiento-pedido.png",
    gallery: [
      { src: "/portafolio-smelendez/tw-seguimiento-pedido.png", label: "Home con snackbar + detalle + mapa en tiempo real" },
    ],
    process: [
      "Pain point identificado: los usuarios no sabían el estado de su pedido tras confirmar la compra",
      "Snackbar contextual en home con estado actual y hora estimada de llegada",
      "Vista de detalle: Ingresado → Preparando → En camino → Entregado",
      "Mapa en tiempo real con ruta del repartidor y datos de origen y destino",
      "Prototipo hi-fi entregado en 2 semanas bajo framework Wizard Sprint",
    ],
    impact: "★ Reduce incertidumbre post-compra · Prototipo aprobado para desarrollo",
  },
  {
    id: 7, name: "MVP Traspasos", category: "Product Design · Fintech · Previsión", year: "2025",
    description: "MVP de herramienta de traspasos previsionales para una AFP líder en Chile. Diseñé el flujo completo de autogestión — desde el ingreso del ejecutivo hasta la confirmación del traspaso — eliminando la necesidad de intermediarios. Dos versiones: flujo cliente directo y flujo asistido por ejecutivo.",
    tags: ["Product Design", "Fintech", "MVP", "UX/UI"],
    color: "#003087", accentColor: "#FFD700",
    imageUrl: "/portafolio-smelendez/afp-productos.png",
    gallery: [
      { src: "/portafolio-smelendez/afp-ejecutivo.png", label: "Home ejecutivo — plataforma de gestión de traspasos" },
      { src: "/portafolio-smelendez/afp-home.png", label: "Inicio del traspaso — formulario vacío" },
      { src: "/portafolio-smelendez/afp-home-datos.png", label: "Formulario con datos del cliente" },
      { src: "/portafolio-smelendez/afp-home-error.png", label: "Estados de error y validación inline" },
      { src: "/portafolio-smelendez/afp-productos.png", label: "Tus productos — selección de cuentas a traspasar" },
      { src: "/portafolio-smelendez/afp-datos-personales.png", label: "Verificación de datos personales" },
      { src: "/portafolio-smelendez/afp-tipo-afiliado.png", label: "Tipo de afiliado — 7 perfiles laborales" },
      { src: "/portafolio-smelendez/afp-confirmacion.png", label: "Resumen y confirmación del traspaso" },
      { src: "/portafolio-smelendez/afp-exito.png", label: "Proceso completado con éxito" },
    ],
    process: [
      "Definición del flujo completo: Ingreso → Validación de identidad → Productos → Datos → Tipo afiliado → Confirmación → Comprobante",
      "Diseño de dos versiones: cliente directo (autogestión) y ejecutivo (asistido)",
      "7 perfiles de tipo de afiliado con criterios claros para personalizar la experiencia",
      "Sistema de validación inline con estados de error específicos por campo",
      "Stepper lateral de progreso visible en todo momento para reducir abandono",
      "Wireframes y prototipado hi-fi con handoff completo al equipo de desarrollo",
    ],
  ...
  return (
    <div className="app">
      ...
      <section id="inicio" className="hero">
        ...
        <div className="hero-right" style={{ justifyContent: "center", alignItems: "center", paddingTop: "0" }}>
